...
// New components for 7-section layout
export { ContentSection } from "./ContentSection";
export { TraitGrid } from "./TraitGrid";
export * from "./DatingCycleVisual";
export * from "./RedFlagsList";
export * from "./CoachingFocusList";
export { ResultsNavSidebar, SECTIONS } from "./ResultsNavSidebar";
export { MobileFloatingNav } from "./MobileFloatingNav";

export type { ScoreData, DimensionData, RankedData } from "./ResultCard";
