...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-12 w-full items-center justify-between rounded-xl border border-slate-200 bg-white px-4 py-3 text-foreground transition-all duration-200",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "hover:bg-[#fffdf6] hover:text-slate-900",
      "focus:bg-[#fffdf6] focus:text-slate-900",
      "data-[state=checked]:bg-[#f9d544]/10 data-[state=checked]:text-slate-900 data-[state=checked]:font-medium",
  ...
  >
    <span className="absolute left-3 flex h-5 w-5 items-center justify-center">
      <SelectPrimitive.ItemIndicator>
        <Check className="h-4 w-4 text-[#f9d544]" />
      </SelectPrimitive.ItemIndicator>
    </span>
